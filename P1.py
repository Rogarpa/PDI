...
test_resized = ImageTk.PhotoImage(im.resize((300, 300)))
Label(left_frame, image=test_resized).grid(row=1, column=0, padx=5, pady=5)

# Display image in right_frame
Label(right_frame, image=test).grid(row=0,column=0, padx=5, pady=5)
