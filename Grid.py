...
original_image = ImageTk.PhotoImage(Image.open("forest.jpg"))
...
Button(tool_bar,  text="Black &amp; White",  command=clicked).grid(row=2,  column=1,  padx=5,  pady=5,  sticky='w'+'e'+'n'+'s')
root.mainloop()