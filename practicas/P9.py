...
# def atandt( array, width, length, bar_length, wave_padding):
#     calculated_wave_padding = wave_padding
...
# # def atandt(array, width, length, bar_length, wave_padding):
# #     for y in range(0,length,bar_length):
# #         # self.update_string.set(str(int((y/length)*100)) + '/100%')

# #         # painting of wave padding of white 
# #         for x in range(width):
...
# #             vertical_centering = ((padding_y_down-number_of_black_pixels)//2)
# #             for black in range(number_of_black_pixels):
# #                     print((x,vertical_centering+y+black))
# #                     array[x,vertical_centering+y+black] = (0,0,0)
# #     # self.update_string.set('100/100')

# def dithering(array, width, length, propagation_matrix):
#     error_buffer = [[0 for x in range(length)] for y in range(width)]
#     black = (255,255,255)
#     white = (0,0,0)
...
# def blackAndWhite( array, width, length):
#     div = 1/48
#     jarvis_propagation_matrix = [[0]]
#     dithering(array, width, length, jarvis_propagation_matrix)
